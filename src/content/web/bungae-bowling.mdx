...
export const metadata = {
  title: "번개볼링",
  description: "번개 지향 볼링 모집 커뮤니티",
  stack: ["Spring Boot", "Java"],
  image: "/projects/web/bungae-bowling/thumbnail.png",
  banner: "/projects/web/bungae-bowling/banner.png",
  start_date: "2023-08-25T00:00:00+0900",
  end_date: "2023-11-17T00:00:00+0900",
  deploy_link: "https://github.com/Step3-kakao-tech-campus/Team3_BE",
  image_list_path: "/projects/web/bungae-bowling/images/",
}
...
**직접 맡은 부분**은 회원가입/로그인으로 대표되는 `인증관련 api`들과 `행정구역 api`, `댓글 api`, `swagger`입니다. 초반 spring boot 프로젝트 세팅을 하며 spring security filter 또한 설정을 하게 되었고, 자연스럽게 security를 비롯한 인증, jwt 토큰, 권한 등의 api들 담당하게 되었습니다. 댓글의 경우 대댓글이 가능하도록 구현하였고, 댓글이 삭제된 경우에도 해당 댓글의 대댓글은 남아 있도록 신경을 썼습니다. **모든 api에 대해 통합 테스트 코드를 작성**하였고 `swagger-ui`로 [api 문서](/files/bungaebowling-api-docs.html)를 배포하였습니다.
...
<Stacks
  stacks={[
    ...
    {
      alt: "AWS S3",
      badge: "https://img.shields.io/badge/AWS%20S3-569A31?style=for-the-badge&logo=amazons3&logoColor=white",
    },
    {
      alt: "AWS EC2",
    ...
    {
      alt: "Naver cloud",
      badge: "https://img.shields.io/badge/naver%20cloud-03C75A?style=for-the-badge&logo=naver&logoColor=white",
    },
    {
      alt: "nginx",
    ...
    {
      alt: "Kubernates",
      badge: "https://img.shields.io/badge/KUBERNETES-326CE5?style=for-the-badge&logo=Kubernetes&logoColor=white",
    },
    {
      alt: "github action",
      badge:
...
![ER Diagram](/projects/web/bungae-bowling/erd.png)
...
<div className={"flex justify-center w-full"}>
  <div className={"max-w-[1000px]"}>
    ![전체구성도](https://github.com/Step3-kakao-tech-campus/Team3_BE/assets/84557643/fe733f3f-168d-4fd0-a55e-4c5c66561cab)
  </div>
</div>
...
<div className={"flex justify-center w-full"}>
  <div className={"max-w-[1000px]"}>
    ![백엔드구성도](https://github.com/Step3-kakao-tech-campus/Team3_BE/assets/81746373/5742bd39-f728-4d9c-94a8-7cd13f9ded09)
  </div>
</div>
...
- Swagger: [/files/bungaebowling-api-docs.html](/files/bungaebowling-api-docs.html)
- github: [https://github.com/Step3-kakao-tech-campus/Team3_BE](https://github.com/Step3-kakao-tech-campus/Team3_BE) <FaGithub className="inline text-lg" />
