...
export const metadata = {
  title: "달리는 알람⏰",
  description: "2022년 임베디드 시스템 설계 및 실험 Term Project",
  stack: ["stmicroelectronics", "C"],
  image: "/projects/sub/running-alarm/thumbnail.png",
  banner: "/projects/sub/running-alarm/banner.png",
  start_date: "2022-10-20T00:00:00+0900",
  end_date: "2022-12-22T00:00:00+0900",
...
![flow diagram](/projects/sub/running-alarm/flow-diagram.png)
