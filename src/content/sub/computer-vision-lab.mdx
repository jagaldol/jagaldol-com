export const metadata = {
  title: "컴퓨터 비전 LAB",
  description: "부산대학교 컴퓨터 비전 개론 LAB",
  stack: ["Computer Vision", "Python"],
  image: "/projects/sub/computer-vision-lab/thumbnail.png",
  banner: "/projects/sub/computer-vision-lab/banner.png",
  start_date: "2023-03-09T00:00:00+0900",
  end_date: "2023-06-13T00:00:00+0900",
  deploy_link: "https://github.com/jagaldol/computer-vision",
  image_list_path: "/projects/sub/computer-vision-lab/images/",
}
...
![hybrid image](/projects/sub/computer-vision-lab/hybrid-image.png)
